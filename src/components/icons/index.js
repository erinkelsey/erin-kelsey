...
export { default as IconAdMob } from './admob'
...
export { default as IconDataScience } from './dataScience'
...
export { default as IconScrum } from './scrum'
...
export { default as IconTeamCity } from './teamcity'
